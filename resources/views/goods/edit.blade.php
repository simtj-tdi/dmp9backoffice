                                    ...
                                    <div class="form-group row">
                                        <div class="col">
                                            ...
                                            <select class="form-control" name="state">
                                                <option value="1" {{ $goods['cart']->state == '1' ? 'selected' : '' }} >요청중</option>
                                                <option value="2" {{ $goods['cart']->state == '2' ? 'selected' : '' }} >추출중</option>
                                                <option value="3" {{ $goods['cart']->state == '3' ? 'selected' : '' }} >승인요청</option>
                                                <option value="5" {{ $goods['cart']->state == '4' ? 'selected' : '' }} >결제완료</option>
                                            </select>
                                        </div>
                                    </div>
